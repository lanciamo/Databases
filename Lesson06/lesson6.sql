...
-- 2.
SET @a = /* ...  перепробовал очень много своих юзеров, но везде empty set. А как собрать запрос, чтобы перебрать разом всех юзеров, чтобы найти тех, у кого хотя бы не empty set, не понимаю*/
